// app/api/admin/community/categories/route.js
...
export async function GET(request) {
  ...
  try {
    ...
    console.log('Categories API Proxy: Token bilgisi:', token ? `${token.substring(0, 15)}...` : 'Yok');
  } catch (error) {
  ...
  try {
    ...
    const backendUrl = `http://localhost:8000/api/community/categories/`;
