...
api_routes = [
    ...
    path('courses/categories/', views.get_course_categories, name='api_course_categories'),
    path('courses/videos/', views.list_videos, name='api_list_videos'),
...
urlpatterns = [
    ...
    path('categories/', views.get_course_categories, name='course-categories'),
